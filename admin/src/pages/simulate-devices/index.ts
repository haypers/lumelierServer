...
import { getSimulateDevicesMarkup } from "./page-markup";
...
function renderSimulateDevicesFull(container: HTMLElement): void {
  ...
  container.innerHTML = getSimulateDevicesMarkup({
    squareSizePx,
    squareSizeMin: SQUARE_SIZE_MIN,
    squareSizeMax: SQUARE_SIZE_MAX,
    openIcon,
    trashIcon,
    noSignalIcon,
  });
